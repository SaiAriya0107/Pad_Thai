...
public class Level2_Stage extends JPanel implements ActionListener {
    ...
    public void paintComponent(Graphics g){
        ...
        if(cos > 0){
            randomc = (int)(Math.random() * (4  - 0 + 0) + 0);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //**********************************//
            ...
            if(checktimepan1 <= 0 && tuppad1 == false && tupkung1 == false && tupmuk1 == false){
            ...
            if(checktimepan2 <= 0 && tuppad2 == false && tupkung2 == false && tupmuk2 == false){
